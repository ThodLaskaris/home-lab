...
const file_scraper_proto_rawDesc = "" +
	...
	"\rDataProcessor\x12G\n" +
	"\x0eStreamProducts\x12\x17.scraper.ProductRequest\x1a\x18.scraper.SummaryResponse\"\x00(\x01B\tZ\a./protob\x06proto3"
...
var file_scraper_proto_depIdxs = []int32{
	...
	1, // 1: scraper.DataProcessor.StreamProducts:output_type -> scraper.SummaryResponse
