...
type MatchRequest struct {
	...
	SourceCategory string                 `protobuf:"bytes,2,opt,name=source_category,json=sourceCategory,proto3" json:"source_category,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *MatchRequest) GetRawText() string {
	if x != nil {
		return x.RawText
	}
	return ""
...
func (x *MatchRequest) GetSourceCategory() string {
	if x != nil {
...
func (x *MatchResponse) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
func (x *MatchResponse) GetScore() float64 {
	if x != nil {
		return x.Score
	}
	return 0
...
func (x *MatchResponse) GetMatchedWith() string {
	if x != nil {
...
const file_proto_scraper_proto_rawDesc = "" +
	"\n" +
	"\x13proto/scraper.proto\x12\x05proto\"~\n" +
	...
	"\x0fsource_category\x18\x02 \x01(\tR\x0esourceCategory\"d\n" +
	"\rMatchResponse\x12\x1a\n" +
	"\bcategory\x18\x01 \x01(\tR\bcategory\x12\x14\n" +
	"\x05score\x18\x02 \x01(\x01R\x05score\x12!\n" +
	"\fmatched_with\x18\x03 \x01(\tR\vmatchedWith2\x91\x01\n" +
	"\rDataProcessor\x12A\n" +
	"\x0eStreamProducts\x12\x15.proto.ProductRequest\x1a\x16.proto.SummaryResponse(\x01\x12=\n" +
	"\x10MatchReceiptItem\x12\x13.proto.MatchRequest\x1a\x14.proto.MatchResponseB)Z'github.com/ThodLaskaris/go-engine/protob\x06proto3"
...
var file_proto_scraper_proto_goTypes = []any{
	...
	(*MatchRequest)(nil),    // 2: proto.MatchRequest
	(*MatchResponse)(nil),   // 3: proto.MatchResponse
}
var file_proto_scraper_proto_depIdxs = []int32{
	0, // 0: proto.DataProcessor.StreamProducts:input_type -> proto.ProductRequest
	2, // 1: proto.DataProcessor.MatchReceiptItem:input_type -> proto.MatchRequest
	1, // 2: proto.DataProcessor.StreamProducts:output_type -> proto.SummaryResponse
	3, // 3: proto.DataProcessor.MatchReceiptItem:output_type -> proto.MatchResponse
